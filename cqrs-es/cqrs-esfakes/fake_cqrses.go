...
type FakeCQRSES struct {
	CreateMessageOfTypeStub        func(string) (cqrs_es.MessageDescriber, error)
	createMessageOfTypeMutex       sync.RWMutex
	createMessageOfTypeArgsForCall []struct {
		arg1 string
	}
	createMessageOfTypeReturns struct {
		result1 cqrs_es.MessageDescriber
		result2 error
	}
...
func (fake *FakeCQRSES) CreateMessageOfType(arg1 string) (cqrs_es.MessageDescriber, error) {
...
func (fake *FakeCQRSES) CreateMessageOfTypeCallCount() int {
...
func (fake *FakeCQRSES) CreateMessageOfTypeCalls(stub func(string) (cqrs_es.MessageDescriber, error)) {
	fake.createMessageOfTypeMutex.Lock()
	defer fake.createMessageOfTypeMutex.Unlock()
	fake.CreateMessageOfTypeStub = stub
}

func (fake *FakeCQRSES) CreateMessageOfTypeArgsForCall(i int) string {
	fake.createMessageOfTypeMutex.RLock()
	defer fake.createMessageOfTypeMutex.RUnlock()
...
func (fake *FakeCQRSES) CreateMessageOfTypeReturns(result1 cqrs_es.MessageDescriber, result2 error) {
	fake.createMessageOfTypeMutex.Lock()
	defer fake.createMessageOfTypeMutex.Unlock()
...
func (fake *FakeCQRSES) CreateMessageOfTypeReturnsOnCall(i int, result1 cqrs_es.MessageDescriber, result2 error) {
	fake.createMessageOfTypeMutex.Lock()
	defer fake.createMessageOfTypeMutex.Unlock()
	fake.CreateMessageOfTypeStub = nil
...
func (fake *FakeCQRSES) CreateUUID() (*uuid.UUID, error) {
...
func (fake *FakeCQRSES) CreateUUIDCallCount() int {
	fake.createUUIDMutex.RLock()
	defer fake.createUUIDMutex.RUnlock()
	return len(fake.createUUIDArgsForCall)
}

func (fake *FakeCQRSES) CreateUUIDCalls(stub func() (*uuid.UUID, error)) {
	fake.createUUIDMutex.Lock()
	defer fake.createUUIDMutex.Unlock()
	fake.CreateUUIDStub = stub
}

func (fake *FakeCQRSES) CreateUUIDReturns(result1 *uuid.UUID, result2 error) {
	fake.createUUIDMutex.Lock()
	defer fake.createUUIDMutex.Unlock()
...
func (fake *FakeCQRSES) CreateUUIDReturnsOnCall(i int, result1 *uuid.UUID, result2 error) {
	fake.createUUIDMutex.Lock()
	defer fake.createUUIDMutex.Unlock()
	fake.CreateUUIDStub = nil
...
func (fake *FakeCQRSES) CreateUUIDString() (string, error) {
...
func (fake *FakeCQRSES) CreateUUIDStringCallCount() int {
	fake.createUUIDStringMutex.RLock()
	defer fake.createUUIDStringMutex.RUnlock()
	return len(fake.createUUIDStringArgsForCall)
}

func (fake *FakeCQRSES) CreateUUIDStringCalls(stub func() (string, error)) {
	fake.createUUIDStringMutex.Lock()
	defer fake.createUUIDStringMutex.Unlock()
	fake.CreateUUIDStringStub = stub
}

func (fake *FakeCQRSES) CreateUUIDStringReturns(result1 string, result2 error) {
	fake.createUUIDStringMutex.Lock()
	defer fake.createUUIDStringMutex.Unlock()
...
func (fake *FakeCQRSES) CreateUUIDStringReturnsOnCall(i int, result1 string, result2 error) {
	fake.createUUIDStringMutex.Lock()
	defer fake.createUUIDStringMutex.Unlock()
	fake.CreateUUIDStringStub = nil
...
func (fake *FakeCQRSES) Invocations() map[string][][]interface{} {
...
func (fake *FakeCQRSES) recordInvocation(key string, args []interface{}) {
...
var _ cqrs_es.CQRSES = new(FakeCQRSES)
